...
class DistillationLoss(torch.nn.Module):
    ...
    def forward(self, inputs, outputs, labels, scores):
        """
        Args:
...
class CustomPruningLoss(nn.Module):
    def __init__(self, c, k, alpha, pi):
        super(CustomPruningLoss, self).__init__()
        self.c = c
        self.k = k
        self.alpha = alpha
        self.pi = pi

    def forward(self, x, target, score):
        # print("balance factor:",self.pi)
