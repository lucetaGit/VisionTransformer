...
from . import swin_quant
from . import vit_quant


def str2model(name):
    d = {
        'deit_tiny': vit_quant.deit_tiny_patch16_224,
        'deit_small': vit_quant.deit_small_patch16_224,
        'deit_base': vit_quant.deit_base_patch16_224,
        'vit_base': vit_quant.vit_base_patch16_224,
        'vit_base_patch16_224': vit_quant.vit_base_patch16_224,
        'vit_large': vit_quant.vit_large_patch16_224,
        'swin_tiny': swin_quant.swin_tiny_patch4_window7_224,
        'swin_small': swin_quant.swin_small_patch4_window7_224,
        'swin_base': swin_quant.swin_base_patch4_window7_224,
    }
